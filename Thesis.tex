...
\input{Tex/0-Frontpages}% title page, abstract, dedication
{% content list region
...
\input{Tex/0-Prematter}% list of symbols, preface content
%-
%-> Mainmatter
%- 
\mainmatter% initialize the environment
\input{Tex/0-Mainmatter}% main content
%-
%-> Appendix
%-
\cleardoublepage%
\appendix% initialize the environment
\input{Tex/z-Appendix}% appendix content
%-
...
\input{Tex/z-Backmatter}% other information
\end{document}
%---------------------------------------------------------------------------%
